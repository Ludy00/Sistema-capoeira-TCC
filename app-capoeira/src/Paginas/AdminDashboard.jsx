    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col md:flex-row font-sans">
      ...
      <div className="md:hidden bg-[#0e0e0e] border-b border-gray-800 p-4 flex justify-between items-center sticky top-0 z-50 shadow-2xl">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-white font-black uppercase tracking-tighter text-xs">Painel do Professor</span>
        </div>
        <button 
      ...
      {/* === SIDEBAR ADMINISTRATIVA (Z-INDEX AUMENTADO) === */}
      <aside className={`
        fixed inset-y-0 left-0 z-[60] w-64 bg-[#111] border-r border-gray-800 transform transition-transform duration-300 ease-in-out
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        {abaAtiva === 'inicio' && (
          <div className="max-w-6xl mx-auto space-y-10 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-[#111] p-8 rounded-3xl border border-gray-800 shadow-xl">
              ...
              <div className="bg-red-900/10 p-8 rounded-3xl border border-red-900/30 shadow-xl">
          ...
          <div className="max-w-5xl mx-auto space-y-8 animate-fadeIn">
            ...
            <div className="bg-[#111] rounded-3xl border border-gray-800 overflow-hidden shadow-2xl">
              ...
              <div className="divide-y divide-gray-800">
                {[
                  { id: 1, nome: 'Milena', idade: 14, tipo: 'Infantil' },
                  { id: 2, nome: 'Ludmyla', idade: 20, tipo: 'Adulto' }
                ].map(aluno => (
        ...
        {abaAtiva === 'agenda' && (
          <div className="max-w-5xl mx-auto space-y-8 animate-fadeIn">
            <div className="flex justify-between items-center">
              ...
              <button className="bg-red-700 hover:bg-red-600 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center shadow-lg shadow-red-900/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {['Segunda', 'Quarta', 'Sexta'].map(dia => (
                <div key={dia} className="bg-[#111] p-6 rounded-3xl border border-gray-800 space-y-4 shadow-lg">
          ...
          <div className="max-w-4xl mx-auto space-y-12 animate-fadeIn">
            ...
            <div className="bg-[#111] p-8 rounded-3xl border border-gray-800 shadow-2xl space-y-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="bg-red-700 hover:bg-red-600 text-white px-8 py-3 rounded-xl font-black uppercase tracking-widest text-[10px] flex items-center shadow-lg shadow-red-900/20">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#111] border border-gray-800 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-xl">
        ...
        {abaAtiva === 'financeiro' && (
          <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
            ...
            <div className="bg-[#111] p-12 rounded-3xl border border-gray-800 text-center shadow-xl">
              <DollarSign className="mx-auto text-green-500 mb-6" size={48} />
              <p className="text-gray-400 font-medium">Em breve: Relatórios de pagamentos detalhados por aluno.</p>
            </div>
          </div>
        )}
      ...
      {/* OVERLAY MOBILE (Z-INDEX AJUSTADO) */}
      {sidebarAberta && (
        <div 
