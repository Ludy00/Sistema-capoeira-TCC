    ...
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 border-t border-gray-900/40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          {/* LADO DIREITO (NA NAVBAR): A FOTO DO PROFESSOR */}
          {/* Note o 'lg:sticky': No PC ela fica fixa, no Celular ela rola normal */}
          <div className="lg:col-span-5 lg:sticky lg:top-32 order-1 lg:order-2 mb-10 lg:mb-0">
          ...
          {/* LADO ESQUERDO: O TEXTO DA HISTÓRIA */}
          <div className="lg:col-span-7 space-y-10 order-2 lg:order-1">
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-wide leading-tight">
                O Berimbau já me <span className="text-transparent bg-clip-text bg-white">Chamava</span>
              </h2>
            </div>
            ...
            <div className="space-y-12 text-lg text-gray-400 leading-relaxed text-justify font-light">
              ...
              <div>
                ...
                <p>
                  Hoje, como <strong>Toquinho Capoeira</strong>, tenho a honra de ser o responsável pela <strong>Escola Muzenza em Parnaíba</strong>. Minha missão não é apenas ensinar movimentos, mas manter viva aquela mesma chama que me fazia descer do ônibus aos quatro anos de idade.
                </p>
              </div>
